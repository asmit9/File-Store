...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8016987496:AAFStCY5H53CxeG-YDGf9cs_Om1xH8gIBIE")
#Your API ID from my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "28095411"))
#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "d69088274fd32c2b98cff97ea7f84546")
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002562910743))
#OWNER USERNAMA OWNER
OWNER = os.environ.get("OWNER", "Your_crus_h")
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "8075306396"))
# OWNER USERNAME WITHOUT @ REQUIRED 
OWNER_USER = os.environ.get("OWNER_USER", "Your_crus_h")
#Port
PORT = os.environ.get("PORT", "8030")
#Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://asmit9831:plmokn123@cluster0.dpnwiza.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "filesharexbot")
#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002431942924"))
